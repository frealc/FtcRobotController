...
public class autoFrontB extends OpMode {
    ...
    private final Pose correct1 = new Pose(-13.15, -17.25, 1.54);
    ...
    private final Pose replace2 = new Pose(12, -17,1.57);

    private final Pose priseballe2 = new Pose(12, -47.26,1.57);
    ...
    scorePreload.setConstantInterpolation(tirePose.getHeading()); */
        ...
        gotopose1 = follower.pathBuilder()
                .addPath(new BezierLine(tirePose, correct1))
                .setLinearHeadingInterpolation(tirePose.getHeading(), correct1.getHeading())
                .build();

        takepose1 = follower.pathBuilder()
                .addPath(new BezierLine(correct1, priseballe1))
