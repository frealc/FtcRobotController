 ...
 * ============================================================================
 */
@TeleOp(name = "DECODEmanette PEDRO Rouge - 25012", group = "Alone")
public class DECODEmanettePEDRO extends LinearOpMode {
    ...
    public void runOpMode() {
         ...
         *  Valeur reprise de teleopPedroR (position de tir arriere rouge).
         */
        final Pose tirePose = new Pose(52.38, 12, 2.73);
        ...
        double fTirAuto = data.vitesse_tir_auto_ar;         // vitesse de tir cible en mode auto (par defaut)
